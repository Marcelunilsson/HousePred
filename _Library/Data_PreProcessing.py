...
def Import_Variables():
    encoder = joblib.load('../_Library/Variables/encoder.joblib')
    scaler = joblib.load('../_Library/Variables/scaler.joblib')
    model = pickle.load(open('../_Library/Variables/model.sav', 'rb'))
